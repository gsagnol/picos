...
class Problem(object):
    ...
    def _zibopt_solve(self):  #Brauchbare Teile der alten Methode kopiert, nicht ben�tigten Block durch model. optimize ersetzt.
        #TODO
        if self.type in (
               'unknown type',
               'GP',
